...
HD_PWD='D:/xilinx_prj/xilinx_Etherent/xtg_ethernet_ex/xtg_ex/xtg_ex.runs/bd_9a86_xpcs_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_9a86_xpcs_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_9a86_xpcs_0.tcl
