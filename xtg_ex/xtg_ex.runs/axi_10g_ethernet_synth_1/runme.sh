...
HD_PWD='D:/xilinx_prj/xilinx_Etherent/xtg_ethernet_ex/xtg_ex/xtg_ex.runs/axi_10g_ethernet_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_10g_ethernet.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_10g_ethernet.tcl
