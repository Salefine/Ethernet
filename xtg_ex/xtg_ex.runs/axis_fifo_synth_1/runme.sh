...
HD_PWD='D:/xilinx_prj/xilinx_Etherent/xtg_ethernet_ex/xtg_ex/xtg_ex.runs/axis_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_fifo.tcl
