...
HD_PWD='E:/xilinx_ETH/eth_lab1/Ethernet/xtg_ex/xtg_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log udp_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source udp_test.tcl -notrace
