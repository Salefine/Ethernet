...
HD_PWD='D:/xilinx_prj/xilinx_Etherent/xtg_ethernet_ex/xtg_ex/xtg_ex.runs/udp_ip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log udp_ip_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source udp_ip_0.tcl
