...
#
# Generated by Vivado on Sat Apr 13 16:45:30 +0800 2024
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2019.1 (64-bit)-id)\n"
...
simulate()
{
  xsim clk_gen -key {Behavioral:sim_1:Functional:clk_gen} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9a86.protoinst" -log simulate.log
}
