...
#
# Generated by export_simulation on Mon Apr 15 09:57:03 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './udp_ip_0.sh' script.

./udp_ip_0.sh -reset_run
...
./udp_ip_0.sh -noclean_files

For more information on the script, please type './udp_ip_0.sh -help'.
